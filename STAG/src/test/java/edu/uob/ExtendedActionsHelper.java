...
public final class ExtendedActionsHelper {
    private static final List<Map<String, Set<String>>> actions;
    ...
    static {
        ...
        Map<String, Set<String>> action0 = populateAction(triggers0, subjects0, consumed0, produced0);
        ...
        Map<String, Set<String>> action1 = populateAction(triggers1, subjects1, consumed1, produced1);
        actions.add(action1);
        ...
        Map<String, Set<String>> action2 = populateAction(triggers2, subjects2, consumed2, produced2);
        actions.add(action2);
        ...
        Map<String, Set<String>> action3 = populateAction(triggers3, subjects3, consumed3, produced3);
        actions.add(action3);
        ...
        Map<String, Set<String>> action4 = populateAction(triggers4, subjects4, consumed4, produced4);
        actions.add(action4);
        ...
        Map<String, Set<String>> action5 = populateAction(triggers5, subjects5, consumed5, produced5);
        actions.add(action5);
        ...
        Map<String, Set<String>> action6 = populateAction(triggers6, subjects6, consumed6, produced6);
        actions.add(action6);
        ...
        Map<String, Set<String>> action7 = populateAction(triggers7, subjects7, consumed7, produced7);
        actions.add(action7);
        ...
        Map<String, Set<String>> action8 = populateAction(triggers8, subject8, consumed8, produced8);
        actions.add(action8);
        ...
        Map<String, Set<String>> action9 = populateAction(triggers9, subject9, consumed9, produce9);
        actions.add(action9);
        ...
        Map<String, Set<String>> action10 = populateAction(triggers10, subject10, consumed10, produce10);
        actions.add(action10);
    }

    private static Map<String, Set<String>> populateAction(String[] triggers, String[] subjects, String[] consumed, String[] produced) {
    ...
    public static Set<String> getActionTriggers(int actionIndex) {
        return getActionAttribute(actionIndex, "triggers");
    }

    public static Set<String> getActionSubjects(int actionIndex) {
        return getActionAttribute(actionIndex, "subjects");
    }

    public static Set<String> getActionProduced(int actionIndex) {
        return getActionAttribute(actionIndex, "produced");
    }

    public static Set<String> getActionConsumed(int actionIndex) {
        return getActionAttribute(actionIndex, "consumed");
    }

    private static Set<String> getActionAttribute(int actionIndex, String attributeType) {
    ...
    public static Set<String> getAllTriggers() {
        ...
        for (Map<String, Set<String>> action : actions) {
